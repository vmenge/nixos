...
The goal is to ask the user what is being worked on, research the surrounding problem, and write useful planning context into `.workstreams/<workstream-name>/design.md`.
...
## Design Contents
This design doc should always contain at least:

1. Context
  A small description of the feature and the problem it solves.
  A list of must read files from the repository. Preferrably specs or docs.
2. Scope / Boundaries
...
5. Critical Files
   List of critical files that will be changed during implementation.
6. Testing Strategy
...
**Documentation:**
- Write the validated design to `.workstreams/<workstream-name>/design.md`
- Use writing-clearly-and-concisely skill if available

**Implementation:**
- Invoke the workstream-plan skill to create a detailed implementation plan
- Do NOT invoke any other skill. workstream-plan is the next step.
