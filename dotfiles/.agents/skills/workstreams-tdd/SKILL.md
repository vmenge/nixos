...
TypeScript is used as examples only, apply the lessons to whatever language you are using in your repository.
...
Use a test command like this, whichever is relevant to your workstream:
```bash
